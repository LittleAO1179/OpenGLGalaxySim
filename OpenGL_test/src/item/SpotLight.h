...
private:
    ...
    VertexBuffer m_VBO = VertexBuffer(m_Vertices, sizeof(float) * 36 * 8);
    VertexBufferLayout m_layout;
    std::shared_ptr<Shader> m_LightShaderP;
    bool hide;
    SpotLightNames m_Names;
    
    static int count;

public:
	SpotLight(VertexArray& VAO, Shader* lightShader);
